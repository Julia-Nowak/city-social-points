...
const IS: Dict = {
  ...
  // nav additions
  nav_how: "Hvernig virkar þetta",
  nav_faq: "Spurt og svarað",
  nav_partners: "Fyrir fyrirtæki",
  // how it works
  how_badge: "Hvernig virkar þetta",
  how_h: "Frá litlu góðverki að stigum á 4 skrefum",
  how_sub: "Reykjavík Stig breytir hversdagslegum góðverkum í áþreifanlegt þakklæti frá borginni.",
  how_s1_t: "1. Skráðu þig",
  how_s1_d: "Opnaðu vefinn í símanum — engin app niðurhal, engin bið.",
  how_s2_t: "2. Gerðu góðverk",
  how_s2_d: "Endurvinndu, taktu strætó, hjálpaðu nágranna eða tíndu rusl.",
  how_s3_t: "3. Safnaðu stigum",
  how_s3_d: "Skráðu verkið og fáðu stig samstundis. Bættu mynd við ef þú vilt.",
  how_s4_t: "4. Leystu út verðlaun",
  how_s4_d: "Eyddu stigunum í sundlaugum, kaffihúsum, söfnum og hjá samstarfsaðilum.",
  how_cta: "Byrjaðu núna",
  // faq
  faq_badge: "Algengar spurningar",
  faq_h: "Spurt og svarað",
  faq_sub: "Allt sem þú þarft að vita um Reykjavík Stig.",
  faq_q1: "Hvað kostar þetta?",
  faq_a1: "Ekkert. Reykjavík Stig er ókeypis fyrir alla borgarbúa og gesti.",
  faq_q2: "Þarf ég að sækja app?",
  faq_a2: "Nei. Þetta er vefur sem virkar í öllum símum og tölvum.",
  faq_q3: "Hvernig vitið þið að ég gerði verkið?",
  faq_a3: "Þetta er heiðurskerfi í bili. Þú getur bætt mynd við sem sönnun — hún er aðeins geymd í þínum síma.",
  faq_q4: "Hvar get ég eytt stigunum?",
  faq_a4: "Hjá samstarfsaðilum okkar — sundlaugum, söfnum, kaffihúsum og fleiri stöðum um alla Reykjavík.",
  faq_q5: "Renna stigin út?",
  faq_a5: "Ekki ennþá. Í frumgerðinni geymast stigin í vafranum þínum.",
  faq_q6: "Get ég látið fyrirtækið mitt vera samstarfsaðila?",
  faq_a6: "Já! Skoðaðu síðuna fyrir fyrirtæki og hafðu samband.",
  faq_more: "Hef ekki fengið svar?",
  faq_more_btn: "Lærðu meira um málefnin",
  // partners
  p_badge: "Fyrir fyrirtæki",
  p_h: "Verðlaunaðu góð verk — fáðu nýja viðskiptavini",
  p_sub: "Gakktu til liðs við sundlaugar, kaffihús, söfn og verslanir sem taka við Reykjavík Stigum og hjálpa borginni að blómstra.",
  p_b1_t: "Nýir gestir",
  p_b1_d: "Borgarbúar með stig í höndunum koma til þín — oft í fyrsta skipti.",
  p_b2_t: "Jákvæð ímynd",
  p_b2_d: "Tengdu vörumerkið þitt við sjálfbærni, samfélag og umhyggju.",
  p_b3_t: "Engin gjöld",
  p_b3_d: "Engin föst gjöld og engin tækni að setja upp — bara einfalt samkomulag.",
  p_b4_t: "Mælanleg áhrif",
  p_b4_d: "Sjáðu hversu margir nýta tilboðin og hvaða áhrif þú hefur á borgina.",
  p_how_h: "Hvernig það virkar fyrir þig",
  p_how_1: "Þú býrð til tilboð — t.d. frír kaffibolli fyrir 40 stig.",
  p_how_2: "Við bætum því við sem verðlaun á vefnum.",
  p_how_3: "Viðskiptavinurinn sýnir staðfestingu í símanum sínum á staðnum.",
  p_cta_t: "Tilbúin að taka þátt?",
  p_cta_d: "Sendu okkur línu og við látum vita hvernig næstu skref líta út.",
  p_cta_btn: "Hafðu samband",
};
...
const EN: Dict = {
  ...
  nav_faq: "FAQ",
  nav_partners: "For businesses",
  // how it works
  how_badge: "How it works",
  how_h: "From a small good deed to civic points in 4 steps",
  how_sub: "Reykjavík Stig turns everyday good deeds into tangible thanks from the city.",
  how_s1_t: "1. Open the site",
  how_s1_d: "Works in any phone browser — no app to download, no account hurdles.",
  how_s2_t: "2. Do a good deed",
  how_s2_d: "Recycle, ride the bus, help a neighbour, or pick up litter in a park.",
  how_s3_t: "3. Earn points",
  how_s3_d: "Log the action and get points instantly. Add a photo if you like.",
  how_s4_t: "4. Redeem rewards",
  how_s4_d: "Spend points at pools, cafés, museums and other Reykjavík partners.",
  how_cta: "Start now",
  // faq
  faq_badge: "FAQ",
  faq_h: "Frequently asked questions",
  faq_sub: "Everything you need to know about Reykjavík Stig.",
  faq_q1: "Is it free?",
  faq_a1: "Yes, completely free for everyone — residents and visitors alike.",
  faq_q2: "Do I need to download an app?",
  faq_a2: "No. Reykjavík Stig is a website that works in any phone or computer browser.",
  faq_q3: "How do you know I really did the deed?",
  faq_a3: "It's an honour system for now. You can attach a photo as proof — it stays only in your own phone.",
  faq_q4: "Where can I spend my points?",
  faq_a4: "At our partner locations — pools, museums, cafés and more across Reykjavík.",
  faq_q5: "Do points expire?",
  faq_a5: "Not yet. In this prototype, points are stored in your browser.",
  faq_q6: "Can my business become a partner?",
  faq_a6: "Absolutely — visit the For businesses page and get in touch.",
  faq_more: "Still have a question?",
  faq_more_btn: "Learn more about the cause",
  // partners
  p_badge: "For businesses",
  p_h: "Reward good deeds — and welcome new customers",
  p_sub: "Join the pools, cafés, museums and shops that accept Reykjavík Stig and help the city thrive.",
  p_b1_t: "New visitors",
  p_b1_d: "Locals with points in hand walk through your door — often for the first time.",
  p_b2_t: "Positive brand",
  p_b2_d: "Connect your brand with sustainability, community and care for the city.",
  p_b3_t: "No fees",
  p_b3_d: "No subscription, no integration to install — just a simple agreement.",
  p_b4_t: "Measurable impact",
  p_b4_d: "See how many people redeem your offer and the civic actions you helped reward.",
  p_how_h: "How it works for you",
  p_how_1: "You design an offer — e.g. a free filter coffee for 40 points.",
  p_how_2: "We list it as a reward on the site.",
  p_how_3: "The customer shows their unlocked reward on their phone in-store.",
  p_cta_t: "Ready to join?",
  p_cta_d: "Send us a line and we'll walk you through the next steps.",
